 ...
 */
final class Version20200602115936 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stats (id INT AUTO_INCREMENT NOT NULL, pilote_id INT NOT NULL, grand_prix_id INT NOT NULL, team_id INT NOT NULL, date_id INT NOT NULL, chrono INT NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_574767AAF510AAE9 (pilote_id), INDEX IDX_574767AA6E53349A (grand_prix_id), INDEX IDX_574767AA296CD8AE (team_id), INDEX IDX_574767AAB897366B (date_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
